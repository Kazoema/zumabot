...
*/
const A187 = 'ZumaBot�'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/lord.zuma45'; // JANGAN UBAH-UBAH INFO!!!
...
conn.sendMessage(id, ' *Iya Kazoema itu ownerku kak... Ada yang bisa dibantu? , Follow Instagram Mimin yah : https://instagram.com/lord.zuma45*' ,MessageType.text);
}
else if (text == 'nabila'){
conn.sendMessage(id, ' *Iyaa Nabila itu Pacarnya ownerku kak... Ada yang bisa dibantu?  , Follow Instagram adek Mimin Yah : https://instagram.com/bilaee19_*' ,MessageType.text);
}
   if (messageType == 'imageMessage')
   {
      let caption = imageMessage.caption.toLocaleLowerCase()
...
//Tolonglah bro jangan di ubah ubah Lord Kazoema ID
